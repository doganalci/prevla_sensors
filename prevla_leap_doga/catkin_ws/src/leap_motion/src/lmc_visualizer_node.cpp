...
bbb=sprintf (buffer,"%f,%f,%d,%d,%d,%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n",palmstamp,fractional_seconds_since_epoch,plmind,pntind,pntind2,HND,FNGR,joint_marker.id,joint_marker.type,location.position.x,location.position.y,location.position.z,location.orientation.x,location.position.Y,location.orientation.z,location.orientation.w,palmx,palmy,palmx);
