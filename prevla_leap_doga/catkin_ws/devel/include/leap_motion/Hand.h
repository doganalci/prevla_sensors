...
struct Hand_
{
  ...
  _pinch_strength_type pinch_strength;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _palm_velocity_type;
  ...
  _sphere_radius_type sphere_radius;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _sphere_center_type;
  _sphere_center_type sphere_center;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _to_string_type;
  _to_string_type to_string;

   typedef std::vector< ::leap_motion::Finger_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::leap_motion::Finger_<ContainerAllocator> >> _finger_list_type;
  _finger_list_type finger_list;

   typedef std::vector< ::leap_motion::Gesture_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::leap_motion::Gesture_<ContainerAllocator> >> _gesture_list_type;
...
struct Printer< ::leap_motion::Hand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::leap_motion::Hand_<ContainerAllocator>& v)
  {
    ...
    s << indent << "to_string: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.to_string);
