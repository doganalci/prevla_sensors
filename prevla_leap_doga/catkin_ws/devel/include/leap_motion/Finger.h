...
struct Finger_
{
  ...
  _to_string_type to_string;
   ...
   typedef std::vector< ::leap_motion::Bone_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::leap_motion::Bone_<ContainerAllocator> >> _bone_list_type;
