...
char kimlik[250]="burak";    // kullanıcı adı buraya girilecek
...
//
  ...
  //  fractional_seconds_since_epoch=std::chrono::duration_cast<std::chrono::duration<double>>(        std::chrono::system_clock::now().time_since_epoch()).count();
        ...
        if (terminal==1 && t==0){
          ...
          char c1[250] ="gnome-terminal -- bash -c ' python3 /home/inosens/Desktop/prevla_sensors/mmwave_ti_ros/ros_driver/src/ti_mmwave_rospkg/src/hand_media.py ";
...
char ttt[250]="";
                    ...
                    printf("\n  hey yooo \n" );
                                        ...
                                        if (bag==0){
                                          ...
                                          //  rosbag::Bag bag("/home/inosens/Desktop/prevla_sensors/mmwave_ti_ros/ros_driver/src/ti_mmwave_rospkg/log/test.bag");
/*                                            std_msgs::Int32 ii;
                                            ii.data = 42;
