...
#inosens@inosens:~/Desktop/hand$ python3 hand_media.py 2 0.0000000001 1 1 w 1 1 doga 50 1  1 str(cfg)
...
fc = open('/home/inosens/Desktop/mmwave_ti_ros/ros_driver/log/image_point_cvs.cvs', file_module)
...
def fun(image_no,x,y,z,delay,damga,image):
    ...
    a='/home/inosens/Desktop/mmwave_ti_ros/ros_driver/save/figure/figure_'+str(deney_no)+'_'+str(image_no)+'_'+str(damga)+'_'+kimlik+'_.png'
    ...
    if im_op==1:
        if fig_save==1:
            ...
            filename_img = '/home/inosens/Desktop/mmwave_ti_ros/ros_driver/save/image_pure/image_'+str(deney_no)+'_'+str(image_no)+'_'+str(damga)+'_'+kimlik+'_.png'
            filename_txt = '/home/inosens/Desktop/mmwave_ti_ros/ros_driver/save/image_txt/image_'+str(deney_no)+'_'+str(image_no)+'_'+str(damga)+'_'+kimlik+'_.png'
...
if ilk ==0:
    if image_no==1 and ff==0 and 0 :
        subprocess.call(['gnome-terminal', '--', 'tail', '-f','/home/inosens/Desktop/mmwave_ti_ros/ros_driver/point_csv_file.cvs'])
        subprocess.call(['gnome-terminal', '--', 'tail', '-f','/home/inosens/Desktop/mmwave_ti_ros/ros_driver/connet_csv_file.cvs'])
        subprocess.call(['gnome-terminal', '--', 'tail', '-f','/home/inosens/Desktop/mmwave_ti_ros/ros_driver/deney_loglari.cvs'])
        ff+=1
    #sira_al('/home/inosens/Desktop/mmwave_ti_ros/ros_driver/deney_loglari.cvs')
    deney_no+=1
